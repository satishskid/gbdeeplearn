                  ...
                  <div className="mt-4 space-y-3">
                    ...
                    {access.length === 0 ? (
                      <p className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 px-4 py-4 text-sm text-slate-500">
                        No enrollments loaded yet. Refresh access to pull the latest learner courses and modules.
                      </p>
                    ) : null}
                  </div>
                </section>
                ...
                <div className="space-y-6">
                  ...
                  <section className="rounded-[1.5rem] border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div className="mt-4 space-y-3">
                      ...
                      {sessions.length === 0 ? (
                        <p className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 px-4 py-4 text-sm text-slate-500">
                          No sessions loaded yet. Refresh sessions to pull your upcoming live class schedule.
                        </p>
                      ) : null}
                    </div>
                  </section>
